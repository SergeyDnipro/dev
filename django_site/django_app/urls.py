...
from django_app.views.CreateRecordView import SingleRecordCreateView, SingleRecordUpdateView, edit_record_view, DeleteView


urlpatterns = [
    path('', StartPage.as_view(), name='start_page'),
    path('users/<str:holder__username>/', GroupPage.as_view(), name='user_page'),
    path('records/<pk>/', edit_record_view, name='element_page'),
